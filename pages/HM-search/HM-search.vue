...
<style>
	.searchBox {width:95%;background-color:#FFD305;padding:7.5px 2.5%;display:flex;justify-content:space-between;}
	...
	.searchBox .inputBox>input {width:100%;height:30px;font-size:16px;border:0;border-radius:16upx;-webkit-appearance:none;-moz-appearance:none;appearance:none;padding:0 3%;margin:0;background-color:#ffffff;}
